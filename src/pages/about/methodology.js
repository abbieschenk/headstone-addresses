...
const Methodology = () => {
    return (
        <AboutLayout> 
            <h1>Methodology</h1>
            <p>
                In compliance with FOIP, we used publicly released data of burial dates and death years from 1995 and earlier, as found using the <a href="https://www.edmonton.ca/programs_services/municipal_cemeteries/cemetery-search.aspx" target="_blank" rel="noreferrer noopener">City of Edmonton Cemetery Search</a>.
            </p>
            <p>
            ...
            <ul>
                <li>
  	                <strong>Mount Pleasant Cemetery</strong> Shortlisted 66 sites, visited 68 sites, and collected 15 complete addresses.
                </li>
                <li>
                    <strong>Edmonton Cemetery</strong> Shortlisted 148 sites, visited 162 sites, and collected 81 complete addresses.
                </li>
                <li>
                    <strong>Beechmount Cemetery</strong> Shortlisted 1796 sites, visited 53 sites, and collected 49 completed addresses.
                </li>
            </ul>
            <p>
